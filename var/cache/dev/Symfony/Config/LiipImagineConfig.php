...
class LiipImagineConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\LiipImagine\MessengerConfig : static)
     */
    public function messenger(array $value = []): \Symfony\Config\LiipImagine\MessengerConfig|static
    {
        if (!\is_array($value)) {
