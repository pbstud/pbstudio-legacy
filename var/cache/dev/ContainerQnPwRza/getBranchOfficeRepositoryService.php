 ...
 */
class getBranchOfficeRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BranchOfficeRepository.php';

        return $container->privates['App\\Repository\\BranchOfficeRepository'] = new \App\Repository\BranchOfficeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
