 ...
 */
class getCouponHistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CouponHistoryRepository' shared autowired service.
     *
     * @return \App\Repository\CouponHistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CouponHistoryRepository.php';

        return $container->privates['App\\Repository\\CouponHistoryRepository'] = new \App\Repository\CouponHistoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
