 ...
 */
class getSecurity_Listener_UserChecker_BackendService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.listener.user_checker.backend' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.user_checker.backend'] = new \Symfony\Component\Security\Http\EventListener\UserCheckerListener(($container->privates['App\\Security\\UserChecker'] ??= new \App\Security\UserChecker()));
    }
}
