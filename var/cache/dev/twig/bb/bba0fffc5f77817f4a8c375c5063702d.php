...
class __TwigTemplate_5c34caef140e563710f24e6ff02ba618 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 12
        yield "    ";
        if ((Twig\Extension\CoreExtension::lengthFilter($this->env, (isset($context["params"]) || array_key_exists("params", $context) ? $context["params"] : (function () { throw new RuntimeError('Variable "params" does not exist.', 12, $this->source); })())) > 0)) {
            // line 13
            yield "        ";
            $context['_parent'] = $context;
        ...
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["selectedValue"]) || array_key_exists("selectedValue", $context) ? $context["selectedValue"] : (function () { throw new RuntimeError('Variable "selectedValue" does not exist.', 17, $this->source); })()), "html", null, true);
        yield "\" name=\"";
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["filterValueName"]) || array_key_exists("filterValueName", $context) ? $context["filterValueName"] : (function () { throw new RuntimeError('Variable "filterValueName" does not exist.', 17, $this->source); })()), "html", null, true);
        yield "\" />

    <button>";
        // line 19
        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 19, $this->source); })()), "button", [], "any", false, false, false, 19), "html", null, true);
        yield "</button>
...
", "@KnpPaginator/Pagination/filtration.html.twig", "C:\\pbstudio\\PBStudio81\\vendor\\knplabs\\knp-paginator-bundle\\templates\\Pagination\\filtration.html.twig");
    }
}
