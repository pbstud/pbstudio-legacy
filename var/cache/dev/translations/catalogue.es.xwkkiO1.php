...
$catalogue = new MessageCatalogue('es', array (
  ...
  array (
    ...
    'user.password.mismatch' => 'Las dos contraseñas no coinciden.',
  ),
  'security' => 
  array (
    ...
    'Invalid credentials.' => 'Datos de acceso inválidos.',
    ...
    'Invalid login details.' => 'Datos de acceso inválidos.',
  ),
  'KnpPaginatorBundle' => 
  array (
  ...
  array (
    ...
    'Filter' => 'Buscar',
    'btn.save' => 'Guardar',
    'btn.update' => 'Guardar Cambios',
    'error.invalid_coupon' => 'El cupón es inválido o ha expirado.',
    'filter.name' => 'Buscar por Nombre',
    'filter.name_code' => 'Buscar por Nombre, Código',
    'filter.transaction_discount.1' => 'Con Descuento',
    'filter.transaction_discount.2' => 'Sin Descuento',
    'help.days_expiry' => 'Vigencia en días',
    'label.active' => 'Activo',
    'label.additional_discount' => 'Descuento Adicional',
    'label.admission_at' => 'Fecha de ingreso',
    'label.address' => 'Dirección',
    'label.alt_text' => 'Descripción',
    'label.amount' => 'Precio',
    'label.apply_special_price' => 'Aplicar a precio especial',
    'label.birthday' => 'Fecha de cumpleaños (dd/mm)',
    'label.branch_office' => 'Sucursal',
    'label.capacity' => 'Capacidad',
    'label.card_last4' => 'Últimos 4 dígitos',
    'label.charge_auth_code' => 'Código de autorización',
    'label.charge_method' => 'Tipo de pago',
    'label.code' => 'Código',
    'label.coupon' => 'Cupón de Descuento',
    'label.created_at' => 'F. Creación',
    'label.date_end' => 'Fecha de Término',
    'label.date_start' => 'Fecha de Inicio',
    'label.days_expiry' => 'Vigencia',
    'label.description' => 'Descripción',
    'label.discipline' => 'Disciplina',
    'label.disciplines' => 'Disciplinas',
    'label.discount' => 'Descuento',
    'label.discount_info' => 'Información del Descuento',
    'label.email' => 'Correo',
    'label.emergency_contact_name' => 'Nombre Contacto Emergencia',
    'label.emergency_contact_phone' => 'Teléfono Contacto Emergencia',
    'label.firstname' => 'Nombre',
    'label.id' => 'ID',
    'label.inactive' => 'Inactivo',
    'label.is_active' => 'Activo',
    'label.is_unlimited' => 'Ilimitado',
    'label.lastname' => 'Apellidos',
    'label.maternal_surname' => 'Apellido materno',
    'label.modality' => 'Modalidad',
    'label.name' => 'Nombre',
    'label.new_user' => 'Aplica para nuevo usuario',
    'label.no' => 'No',
    'label.package' => 'Paquete',
    'label.packages' => 'Paquetes',
    'label.password' => 'Contraseña',
    'label.paternal_surname' => 'Apellido paterno',
    'label.phone' => 'Teléfono',
    'label.photo_file' => 'Imagen para perfil',
    'label.place' => 'Lugar',
    'label.places_not_available' => 'Lugares no Disponibles',
    'label.public' => 'Público',
    'label.repeat_password' => 'Repetir contraseña',
    'label.special_price' => 'Precio Especial',
    'label.telephone' => 'Teléfono',
    'label.total_classes' => 'Número de clases',
    'label.type' => 'Tipo',
    'label.updated_at' => 'F. Actualización',
    'label.user' => 'Usuario',
    'label.username' => 'Usuario',
    'label.used' => 'Usados',
    'label.uses_total' => 'Total de Usos',
    'label.yes' => 'Si',
    'main.backend_branchoffice' => 'Sucursales',
    'main.backend_branchoffice_edit' => 'Editar Sucursal',
    'main.backend_branchoffice_new' => 'Nueva Sucursal',
    'main.backend_coupon' => 'Cupones',
    'main.backend_coupon_edit' => 'Editar Cupón',
    'main.backend_coupon_new' => 'Nuevo Cupón',
    'main.backend_coupon_show' => 'Detalle de Cupón',
    'main.backend_configuration' => 'Configuración',
    'main.backend_discipline' => 'Disciplinas',
    'main.backend_discipline_edit' => 'Editar Disciplina',
    'main.backend_discipline_new' => 'Nueva Disciplina',
    'main.backend_exerciseroom' => 'Salones',
    'main.backend_exerciseroom_edit' => 'Editar Salón',
    'main.backend_exerciseroom_new' => 'Nuevo Salón',
    'main.backend_instructor' => 'Instructores',
    'main.backend_instructor_edit' => 'Datos Generales',
    'main.backend_instructor_new' => 'Nuevo Instructor',
    'main.backend_package' => 'Paquetes',
    'main.backend_package_edit' => 'Editar Paquete',
    'main.backend_package_new' => 'Nuevo Paquete',
    'main.backend_page' => 'Páginas',
    'main.backend_page_edit' => 'Editar Página',
    'main.backend_page_new' => 'Nueva Página',
    'main.backend_session' => 'Clases',
    'main.backend_session_day' => 'Clases x día',
    'main.backend_session_day_edit' => 'Editar clases x día programadas',
    'main.backend_session_day_new' => 'Programar clases x día',
    'main.backend_session_edit' => 'Editar Clase',
    'main.backend_session_new' => 'Nueva Clase',
    'main.backend_session_reservations' => 'Listado de Reservaciones',
    'main.backend_session_waitinglist' => 'Lista de Espera',
    'main.backend_staff' => 'Staff',
    'main.backend_staff_edit' => 'Editar Staff',
    'main.backend_staff_new' => 'Nuevo Staff',
    'main.backend_stats' => 'Estadísticas',
    'main.backend_transaction' => 'Transacciones',
    'main.backend_transaction_new' => 'Caja',
    'main.backend_transaction_show' => 'Detalle Transacciones',
    'main.backend_user' => 'Listado',
    'main.backend_user_edit' => 'Editar Usuario',
    'main.backend_user_show' => 'Perfil del usuario',
    'main.backend_user_new' => 'Nuevo registro',
    'main.catalog' => 'Catálogos',
    'main.dashboard' => 'Dashboard',
    'main.payment' => 'Pagos',
    'main.report' => 'Reportes',
    'main.system' => 'Sistema',
    'main.user' => 'Usuarios',
    'package_type.group' => 'Grupal',
    'package_type.individual' => 'Individual',
    'payment.free' => 'Gratis',
    'payment.cash' => 'Pago en caja',
    'payment.card' => 'Pago con tarjeta',
    'payment.pos' => 'Pago con terminal',
    'placeholder.select' => '- Seleccionar -',
    'resetting.check_email' => 'Un email ha sido enviado a tu correo electrónico. Haz clic en el enlace de activación para restablecer tu contraseña.
Nota: El enlace solo estará activado %tokenLifetime% horas. Si no recibes el correo electrónico, revisa tu carpeta de correo no deseado o inténtalo de nuevo.',
    'resetting.flash.error.active_request' => 'Un email ya ha sido enviado a tu correo electrónico. Haz clic en el enlace de activación para restablecer tu contraseña.
Nota: El enlace solo estará activado %tokenLifetime% horas. Si no recibes el correo electrónico, revisa tu carpeta de correo no deseado o inténtalo de nuevo.',
  ),
));
