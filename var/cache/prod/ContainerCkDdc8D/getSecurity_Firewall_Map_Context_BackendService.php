 ...
 */
class getSecurity_Firewall_Map_Context_BackendService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.firewall.map.context.backend'] = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['security.firewall.authenticator.backend'] ?? $container->load('getSecurity_Firewall_Authenticator_BackendService'));
            yield 3 => ($container->privates['security.access_listener'] ?? $container->load('getSecurity_AccessListenerService'));
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, ($container->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), $c, 'backend', $a, NULL, NULL, ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $c, ($container->privates['security.event_dispatcher.backend'] ?? self::getSecurity_EventDispatcher_BackendService($container)), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'backend_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('backend', 'App\\Security\\UserChecker', '.security.request_matcher.8ZOnKuO', true, false, 'security.user.provider.concrete.app_staff_provider', 'backend', 'security.authenticator.form_login.backend', NULL, NULL, ['form_login', 'remember_me'], NULL, ['path' => 'backend_logout', 'target' => 'backend_login', 'enable_csrf' => NULL, 'csrf_token_id' => 'logout', 'csrf_parameter' => '_csrf_token', 'invalidate_session' => true, 'clear_site_data' => [], 'delete_cookies' => []]), ($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()));
    }
}
