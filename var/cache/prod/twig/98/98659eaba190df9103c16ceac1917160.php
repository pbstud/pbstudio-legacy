...
class __TwigTemplate_407c86b97d54eac038a4c127c055752d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        if ($this->env->getRuntime('App\Twig\Runtime\AppExtensionRuntime')->isAllowedRoute("backend_user_reservation_new")) {
            ...
            yield "            <li>
                <button href=\"";
            // line 7
            yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("backend_user_reservation_new", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "id", [], "any", false, false, false, 7)]), "html", null, true);
    ...
    <div class=\"x_panel x_panel_filters\">
        ...
        // line 16
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("backend_user_reservations", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "id", [], "any", false, false, false, 16)]), "html", null, true);
        yield "\" method=\"get\">
                <div class=\"row\">
        ...
        // line 32
        yield Twig\Extension\EscaperExtension::escape($this->env, ($context["filter_session_date_start"] ?? null), "html", null, true);
        yield "\" />
        ...
        // line 42
        yield Twig\Extension\EscaperExtension::escape($this->env, ($context["filter_session_date_end"] ?? null), "html", null, true);
        yield "\" />
                            <span class=\"form-control-feedback right\" aria-hidden=\"true\">
                                <i class=\"fa fa-calendar\" aria-hidden=\"true\"></i>
                            </span>
        ...
        // line 68
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(($context["exercise_rooms"] ?? null));
...
";
    ...
    {
        return array (  188 => 75,  181 => 73,  170 => 71,  166 => 70,  161 => 69,  157 => 68,  146 => 59,  135 => 57,  131 => 56,  114 => 42,  101 => 32,  90 => 24,  86 => 23,  81 => 21,  73 => 16,  67 => 12,  59 => 7,  56 => 6,  54 => 5,  51 => 4,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "backend/user/reservation/wrapper_list.html.twig", "/var/www/pbstudio/releases/81/templates/backend/user/reservation/wrapper_list.html.twig");
    }
}
