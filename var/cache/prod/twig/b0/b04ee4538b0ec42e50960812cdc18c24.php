...
class __TwigTemplate_c6ff634d4eb59f69b1d5a7be8956999e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Security/Collector/icon.svg", "/var/www/pbstudio/releases/81/vendor/symfony/security-bundle/Resources/views/Collector/icon.svg");
    }
}
